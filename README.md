...
| Current optimized path | 11,142 | 623,465 |
...
1,000 ordinary rules in about 0.91 ms; this is configuration compilation, not
...
The current streaming renderer measures about 0.66 ms, 387,145 B/op, and
