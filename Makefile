...
benchmark-protect:
	go test ./internal/protect ./internal/backend/nft -run '^$$' -bench 'Benchmark(JournalFailureDetection|CrowdSecDecisionDecode|ThreatBanSetCompile|RulesetCompile|LimitRulesetCompile|RulesetRender|LimitRulesetRender)$$' -benchmem
