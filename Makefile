...
benchmark-protect:
	go test ./internal/protect ./internal/backend/nft ./internal/rule -run '^$$' -bench 'Benchmark(JournalFailureDetection|CrowdSecDecisionDecode|ThreatBanSetCompile|RulesetCompile|LimitRulesetCompile|RulesetRender|LimitRulesetRender|RuleMatch1000)$$' -benchmem
